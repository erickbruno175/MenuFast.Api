...
namespace MenuFast.Api.Api.Controllers {
    ...
    public class CaixaController : ControllerBase {
        ...
        public async Task<IActionResult> AbrirCaixa(int funcionarioId, string nome = "Caixa") {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Sangria(int funcionarioId, decimal valor, string? descricao = null) {
            var lojaId = _usuarioContext.LojaId()!.Value;
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Suprimento(int funcionarioId, decimal valor, string? descricao = null) {
            var lojaId = _usuarioContext.LojaId()!.Value;
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> FecharCaixa(int funcionarioId, decimal valorFechamento) {
            var lojaId = _usuarioContext.LojaId()!.Value;
