...
public class ProdutoConfig : IEntityTypeConfiguration<Produto> {
    public void Configure(EntityTypeBuilder<Produto> builder) {
        ...
        builder.Property(x => x.Descricao).HasMaxLength(500).HasComment("Descrição do produto.");
        builder.Property(x => x.Preco).HasPrecision(18, 2).HasComment("Preço de venda do produto.");
        builder.Property(x => x.Custo).HasPrecision(18, 2).HasComment("Custo do produto.");
        builder.Property(x => x.CodigoBarras).HasMaxLength(50).HasComment("Código de barras do produto.");
