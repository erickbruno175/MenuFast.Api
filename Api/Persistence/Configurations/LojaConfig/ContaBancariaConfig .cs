...
public class ContaBancariaConfig : IEntityTypeConfiguration<ContaBancaria> {
    public void Configure(EntityTypeBuilder<ContaBancaria> builder) {
        ...
        builder.Property(x => x.LojaId).HasComment("Loja proprietária da conta bancária.");
        ...
        builder.HasOne(x => x.Loja).WithMany(x => x.ContasBancarias).HasForeignKey(x => x.LojaId).OnDelete(DeleteBehavior.Cascade);
