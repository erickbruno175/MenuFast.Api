        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identificador único do cliente.")
                        .Annotation("SqlServer:Identity", "1001, 1"),
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja à qual o cliente pertence."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identificador único da configuração do restaurante.")
                        .Annotation("SqlServer:Identity", "1001, 1"),
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja vinculada à configuração do restaurante."),
                    ...
                    EnviarPedidoAutomaticamenteBar = table.Column<bool>(type: "bit", nullable: false, comment: "Indica se o pedido deve ser enviado automaticamente para o bar."),
                    Ativo = table.Column<bool>(type: "bit", nullable: false, comment: "Indica se a configuração está ativa.")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfiguracaoLoja", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConfiguracaoLoja_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identificador único da conta bancária.")
                        .Annotation("SqlServer:Identity", "1001, 1"),
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja proprietária da conta bancária."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContaBancaria_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja responsável pela conta a pagar."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContaPagar_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identificador único do horário de funcionamento.")
                        .Annotation("SqlServer:Identity", "1001, 1"),
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja vinculada ao horário de funcionamento."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HorarioFuncionamento_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormaPagamento_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriaProduto_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessaoAtiva = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HistoricoAcessos_Funcionario_FuncionarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuncionarioId = table.Column<int>(type: "int", nullable: true, comment: "Funcionário responsável pelo pedido."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja vinculada ao movimento de caixa."),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MovimentoCaixa_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuncionarioId = table.Column<int>(type: "int", nullable: false, comment: "Funcionário responsável pela entrega."),
                    ...
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja vinculada à entrega.")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entrega", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entrega_Cliente_ClienteEnderecoId",
                        column: x => x.ClienteEnderecoId,
                        principalTable: "Cliente",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entrega_Funcionario_FuncionarioId",
                        column: x => x.FuncionarioId,
                        principalTable: "Funcionario",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Entrega_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuncionarioId = table.Column<int>(type: "int", nullable: false, comment: "Funcionário responsável pela ação."),
                    ...
                    UsuarioId = table.Column<int>(type: "int", nullable: false, comment: "Usuário responsável pela ação."),
                    LojaId = table.Column<int>(type: "int", nullable: false, comment: "Loja vinculada ao histórico do pedido.")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoPedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricoPedido_Funcionario_FuncionarioId",
                        column: x => x.FuncionarioId,
                        principalTable: "Funcionario",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HistoricoPedido_Loja_LojaId",
                        column: x => x.LojaId,
                        principalTable: "Loja",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriaProduto_LojaId",
                table: "CategoriaProduto",
                column: "LojaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConfiguracaoLoja_LojaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContaBancaria_LojaId",
                table: "ContaBancaria",
                column: "LojaId");

            migrationBuilder.CreateIndex(
                name: "IX_ContaPagar_LojaId",
                table: "ContaPagar",
                column: "LojaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entrega_ClienteEnderecoId",
                table: "Entrega",
                column: "ClienteEnderecoId");

            migrationBuilder.CreateIndex(
                name: "IX_Entrega_FuncionarioId",
                table: "Entrega",
                column: "FuncionarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Entrega_LojaId",
                table: "Entrega",
                column: "LojaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAcessos_FuncionarioId",
                table: "HistoricoAcessos",
                column: "FuncionarioId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoAcessos_LojaId",
                table: "HistoricoAcessos",
                column: "LojaId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoPedido_FuncionarioId",
                table: "HistoricoPedido",
                column: "FuncionarioId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoPedido_LojaId",
                table: "HistoricoPedido",
                column: "LojaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HorarioFuncionamento_LojaId",
